        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    prancheId = table.Column<int>(type: "int", nullable: false),
                    companyId = table.Column<int>(type: "int", nullable: false),
                    createdAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    createdBy = table.Column<int>(type: "int", nullable: false),
                    modifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    productsCompanyId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductsCompanies_productsCompanyId",
                        column: x => x.productsCompanyId,
                        principalTable: "ProductsCompanies",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_Pranches_prancheId",
                        column: x => x.prancheId,
                        principalTable: "Pranches",
                        principalColumn: "pranchId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    prancheId = table.Column<int>(type: "int", nullable: true),
                    companyId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_Pranches_prancheId",
                        column: x => x.prancheId,
                        principalTable: "Pranches",
                        principalColumn: "pranchId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaceInvoices_Pranches_prancheId",
                        column: x => x.prancheId,
                        principalTable: "Pranches",
                        principalColumn: "pranchId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaceInvoices_Users_userId",
                        column: x => x.userId,
                        principalTable: "Users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnedInvoices_Pranches_prancheId",
                        column: x => x.prancheId,
                        principalTable: "Pranches",
                        principalColumn: "pranchId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReturnedInvoices_Users_userId",
                        column: x => x.userId,
                        principalTable: "Users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shifts_Pranches_prancheId",
                        column: x => x.prancheId,
                        principalTable: "Pranches",
                        principalColumn: "pranchId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_productsInPranche", x => x.id);
                    table.ForeignKey(
                        name: "FK_productsInPranche_Pranches_prancheId",
                        column: x => x.prancheId,
                        principalTable: "Pranches",
                        principalColumn: "pranchId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_productsInPranche_Products_productId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    productInPranchetId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    prancheId = table.Column<int>(type: "int", nullable: true),
                    companyId = table.Column<int>(type: "int", nullable: false),
                    productInPranchetId = table.Column<int>(type: "int", nullable: true),
                    purchaceInvoiceDetailsId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsToSell_Pranches_prancheId",
                        column: x => x.prancheId,
                        principalTable: "Pranches",
                        principalColumn: "pranchId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductsToSell_productsInPranche_productInPranchetId",
                        column: x => x.productInPranchetId,
                        principalTable: "productsInPranche",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_prancheId",
                table: "Customers",
                column: "prancheId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_prancheId",
                table: "Invoices",
                column: "prancheId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_productsCompanyId",
                table: "Products",
                column: "productsCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_productsInPranche_prancheId",
                table: "productsInPranche",
                column: "prancheId");

            migrationBuilder.CreateIndex(
                name: "IX_productsInPranche_productId",
                table: "productsInPranche",
                column: "productId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsToSell_prancheId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsToSell_productInPranchetId",
                table: "ProductsToSell",
                column: "productInPranchetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaceInvoices_prancheId",
                table: "PurchaceInvoices",
                column: "prancheId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaceInvoices_userId",
                table: "PurchaceInvoices",
                column: "userId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnedInvoices_prancheId",
                table: "ReturnedInvoices",
                column: "prancheId");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnedInvoices_userId",
                table: "ReturnedInvoices",
                column: "userId");
